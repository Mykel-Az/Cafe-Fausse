...
const MENU = {
    Starters: [
        { name: "Bruschetta", price: "$8.50", desc: "Fresh tomatoes, basil, olive oil on toasted baguette", img: "/Menu_img/starters_img/Bruschetta.png" },
        { name: "Caesar Salad", price: "$9.00", desc: "Crisp romaine with homemade Caesar dressing", img: "/Menu_img/starters_img/Caesar-Salad.png" },
    ],
    Mains: [
    ...
    Desserts: [
        { name: "Tiramisu", price: "$7.50", desc: "Classic Italian dessert with mascarpone", img: "/Menu_img/desserts_img/Tiramisu.png" },
        { name: "Cheesecake", price: "$7.00", desc: "Creamy cheesecake with berry compote", img: "/Menu_img/desserts_img/Cheesecake.png" },
    ],
    Beverages: [
        { name: "Red Wine (Glass)", price: "$10.00", desc: "Chef's curated selection", img: "/Menu_img/beverages_img/Red-Wine.png" },
        { name: "White Wine (Glass)", price: "$9.00", desc: "Crisp and refreshing", img: "/Menu_img/beverages_img/White-Wine.png" },
        { name: "Craft Beer", price: "$6.00", desc: "Locally brewed selection", img: "/Menu_img/beverages_img/Craft-Beer.png" },
        { name: "Espresso", price: "$3.00", desc: "Rich, bold Italian espresso", img: "/Menu_img/beverages_img/Espresso.png" },
    ],
};
        ...
        <main id="main" className="has-hero">
            ...
            <div className="page-hero" aria-hidden="true">
                <div
                    ...
                    style={{ backgroundImage: "url('/gallery_img/Grand-Dining-Hall.png')" }}
                />
